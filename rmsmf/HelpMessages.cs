    ...
    public static class HelpMessages
    {
        ...
        private static string[] GetRmsmfHelpEnglish()
        {
            return new string[]
            {
                ...
                "    (Basic usage)",
                "",
                "rmsmf /r:words.csv *.txt /c:us-ascii /w:utf-8 /b:true ",
                "    (Change character encoding from us-ascii to utf-8 and add BOM)",
                "",
                "rmsmf /r:words.csv *.txt /c:us-ascii /w:utf-8 /b:false ",
        ...
        private static string[] GetRmsmfHelpKorean()
        {
            return new string[]
            {
                ...
                "    (기본 사용법)",
                "",
                "rmsmf /r:words.csv *.txt /c:ks_c_5601-1987 /w:utf-8 /b:true ",
                "    (문자 인코딩을 ks_c_5601-1987에서 utf-8로 변경하고 BOM 추가)",
                "",
                "rmsmf /r:words.csv *.txt /c:ks_c_5601-1987 /w:utf-8 /b:false ",
                "    (문자 인코딩을 ks_c_5601-1987에서 utf-8로 변경하고 BOM 제거)",
                "",
                "rmsmf /r:words.csv *.txt /w:utf-8 /b:true ",
                "    (문자 인코딩을 utf-8로 변경하고 BOM 추가 :인코딩 자동 감지)",
                "",
                "rmsmf /r:words.csv *.txt /w:ks_c_5601-1987 ",
                "    (문자 인코딩을 ks_c_5601-1987로 변경 :인코딩 자동 감지)",
                "",
                "",
                "・문자 인코딩만 변경하는 예:\n",
                "",
                "rmsmf *.txt /c:ks_c_5601-1987 /w:utf-8 /b:true ",
                "",
                "rmsmf *.txt /c:utf-8 /w:ks_c_5601-1987 ",
                "",
                "rmsmf *.txt /w:utf-8 /b:true ",
                "    (문자 인코딩을 utf-8로 변경하고 BOM 추가 :인코딩 자동 감지)",
                "",
        ...
        private static string[] GetRmsmfHelpChineseSimplified()
        {
            return new string[]
            {
                ...
                "    （基本用法）",
                "",
                "rmsmf /r:words.csv *.txt /c:gb18030 /w:utf-8 /b:true ",
                "    （将字符编码从gb18030更改为utf-8并添加BOM）",
                "",
                "rmsmf /r:words.csv *.txt /c:gb18030 /w:utf-8 /b:false ",
                "    （将字符编码从gb18030更改为utf-8并删除BOM）",
                "",
                "rmsmf /r:words.csv *.txt /w:utf-8 /b:true ",
                "    （将字符编码更改为utf-8并添加BOM :自动检测编码）",
                "",
                "rmsmf /r:words.csv *.txt /w:gb18030 ",
                "    （将字符编码更改为gb18030 :自动检测编码）",
                "",
                "",
                "・仅更改字符编码的示例：\n",
                "",
                "rmsmf *.txt /c:gb18030 /w:utf-8 /b:true ",
                "",
                "rmsmf *.txt /c:utf-8 /w:gb18030 ",
                "",
                "rmsmf *.txt /w:utf-8 /b:true ",
        ...
        private static string[] GetRmsmfHelpChineseTraditional()
        {
            return new string[]
            {
                ...
                "    （基本用法）",
                "",
                "rmsmf /r:words.csv *.txt /c:big5 /w:utf-8 /b:true ",
                "    （將字元編碼從big5變更為utf-8並新增BOM）",
                "",
                "rmsmf /r:words.csv *.txt /c:big5 /w:utf-8 /b:false ",
                "    （將字元編碼從big5變更為utf-8並刪除BOM）",
                "",
                "rmsmf /r:words.csv *.txt /w:utf-8 /b:true ",
                "    （將字元編碼變更為 utf-8並新增BOM :自動偵測編碼）",
                "",
                "rmsmf /r:words.csv *.txt /w:big5 ",
                "    （將字元編碼變更為 big5 :自動偵測編碼）",
                "",
                "",
                "・僅變更字元編碼的範例：\n",
                "",
                "rmsmf *.txt /c:big5 /w:utf-8 /b:true ",
                "",
                "rmsmf *.txt /c:utf-8 /w:big5 ",
                "",
                "rmsmf *.txt /w:utf-8 /b:true ",
                "    （將字元編碼變更為 utf-8並新增BOM :自動偵測編碼）",
                "",
